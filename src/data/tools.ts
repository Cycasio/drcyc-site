...
export const TOOLS: ToolMeta[] = [
  {
    ...
    pageHeading: 'BMI 計算機',
    shortLabel: 'BMI',
    description: '免費 BMI 計算機，採用台灣衛福部國民健康署成人肥胖分級（過輕、健康、過重、輕度／中度／重度肥胖）。由義大醫院家醫科陳昱彰醫師（具台灣肥胖醫學會認證）整理，附減重藥物適應症與門診入口。',
    keyword: 'BMI 計算機',
    emoji: '⚖️',
    category: '減重核心',
  ...
  },
  {
    ...
    shortLabel: 'TDEE',
    description: '依 BMR 與活動量計算 TDEE（每日總熱量需求），自動推算每週減 0.5 / 1 kg 的建議攝取熱量，並標示安全攝取下限。由義大醫院家醫科陳昱彰醫師（具台灣肥胖醫學會認證）整理。',
    keyword: 'TDEE 計算機',
    emoji: '🍽️',
    category: '減重核心',
  ...
  },
  {
    ...
    title: '腸泌素類減重藥物資格評估｜GLP-1 與 GIP/GLP-1 適應症｜陳昱彰醫師',
    pageHeading: '腸泌素類減重藥物資格評估',
    shortLabel: '腸泌素藥物資格',
    description: '依 BMI 與共病條件初步了解腸泌素類減重藥物的常見適應條件：Wegovy、Saxenda 為 GLP-1 類，Mounjaro（tirzepatide）為 GIP/GLP-1 雙受體促效劑。含禁忌症提醒與門診評估入口。',
    keyword: 'GLP-1 適應症',
    emoji: '💉',
    category: '臨床評估',
