...
export const TOPICS: Topic[] = [
  {
    ...
    description:
      '從肥胖醫學與臨床實務角度，講清楚 GLP-1 受體促效劑 semaglutide 與 GIP/GLP-1 雙重受體促效劑 tirzepatide 的作用機轉、實際效果、副作用、停藥後體重回升與適用對象。員工最想知道的「那支減重針到底能不能打」，我用臨床試驗結果說明。',
  ...
  },
  {
    ...
    description:
      '用員工健檢報告的實際資料解讀三高風險。什麼時候該吃藥?藥物副作用真的那麼可怕嗎?為什麼有人吃藥吃到失控?一場演講讓員工對自己的慢性病管理建立正確觀念。',
...
export const FORMATS: Format[] = [
  ...
  },
  {
    duration: '半日 3 小時',
    name: '工作坊 / 內訓課程',
    bestFor: '企業 HR 教育訓練、職安衛委員會、健康管理師進階訓練',
...
export const FAQ = [
  ...
  {
    q: '可以客製化講題內容嗎?',
    a: '可以也建議。企業場次我會先了解貴公司員工的健檢資料重點、最需要改善的職場健康問題、已經做過的健康促進活動,把內容調整到「員工真的關心的問題」。客製比照標準化演講效果好很多,這是行為改變的關鍵。',
  },
  {
    q: '服務範圍到哪裡?北部也接嗎?',
  ...
  {
    q: '可以同時安排現場健康諮詢嗎?',
    a: '可以。部分企業場次會搭配演講後的「一對一健康諮詢站」(每人 5–10 分鐘),讓員工針對個別健檢資料提問。這個服務需要額外時段,請在邀約時一併說明需求。',
  },
  {
    q: '演講結束會提供講義或追蹤資料嗎?',
