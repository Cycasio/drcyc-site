---
title: "第二型糖尿病可以逆轉嗎？減重多少才有機會讓糖尿病緩解"
description: "第二型糖尿病真的可以「緩解」嗎？用 DiRECT、STEP-1、SURMOUNT-4、STAMPEDE 的實際數字告訴你：體重要掉多少、停藥會不會胖回去、藥物跟手術的真實效果，讓國中生也看得懂。"
pubDate: 2026-04-13
...
faq:
  - q: "第二型糖尿病真的可以「緩解」嗎？"
    a: "可以，但有前提。國際共識的定義是：HbA1c 小於 6.5%、並且停掉所有降血糖藥至少 3 個月。最有代表性的 DiRECT 研究顯示，透過結構化減重計畫，1 年後約 46% 的人進入緩解。但緩解不等於永遠治好——如果後來又胖回去，糖尿病通常會再回來。"
  - q: "要減多少公斤才有機會讓糖尿病緩解？"
    a: "根據 DiRECT 研究，體重下降幅度和緩解率呈強烈正相關：1 年內完全沒減的人 0%、減不到 5 公斤約 7%、減 5–10 公斤 34%、減 10–15 公斤 57%、減超過 15 公斤 86%。白話講：掉越多，機會越大。"
  - q: "停掉 Ozempic 或猛健樂（Mounjaro）以後會復胖嗎？"
    a: "大部分人會。STEP-1 延伸研究顯示停掉 semaglutide 1 年後，平均胖回約 2/3 的減重。SURMOUNT-4 研究顯示停掉 tirzepatide 的人 1 年胖回 14%，繼續打的人反而再多瘦 5.5%。這類藥比較像高血壓藥一樣的長期管理工具，不是短期療程。"
  - q: "糖尿病緩解之後就可以永遠不吃藥了嗎？"
    a: "不一定。Remission 是『目前在沒有用藥的情況下血糖達標』的狀態，而不是『永遠痊癒』。DiRECT 五年追蹤發現，能長期維持體重下降超過 10 公斤的人，緩解才有辦法持續；復胖的人通常糖尿病也跟著回來。所以維持體重才是真正的關鍵。"
  - q: "減重手術跟減重藥物哪個效果比較好？"
    a: "只看糖尿病緩解率，代謝手術目前效果最強。美國 STAMPEDE 研究 5 年追蹤顯示，胃繞道手術的緩解率 29%、胃袖狀切除 23%、只做藥物治療 5%。但手術有適應症、風險與長期追蹤需求，不是每個人都適合，需要跟醫師評估。"
  - q: "已經吃糖尿病藥很多年了，還有機會 remission 嗎？"
    a: "機會會下降，但不是零。病程越短、胰臟 β 細胞功能保留越多、體重下降幅度越大，機會越大。已經吃藥多年的人仍然值得減重——就算沒進入正式的 remission，血糖控制、併發症風險與用藥量都會明顯改善。"
tldr:
...
像 **semaglutide**（Ozempic、Wegovy 同成分）、**tirzepatide**（猛健樂 Mounjaro）這類藥之所以重要，不是因為它們「直接治好糖尿病」，而是因為它們**讓很多以前怎麼減都瘦不下來的人，真的瘦下來了**。

既然 DiRECT 已經告訴我們「減得多＝機會大」，那能幫你減更多的藥，自然就能拉高你的緩解機率。

它們的角色比較像是：**幫助生活型態真正執行下去的工具。**

> 想深入了解猛健樂的效果、副作用與適用對象，可以看這篇：[猛健樂 Mounjaro 完整指南](/blog/mounjaro-weight-loss/)。
...
原本打 68 週，平均瘦了 **17.3%**。
停藥後 1 年，**平均胖回約 2/3 的減重**，最後淨減重只剩下大約 **5.6%**。
...
> 有些人確實有機會進入緩解。但真正重要的，不是把這個診斷名稱拿掉，而是**未來幾十年過得好不好**。
...
因為如果只是短期瘦一下、血糖漂亮一下，之後又全部回升，對身體其實幫助有限。
...
7. Riddle MC, et al. Consensus Report: Definition and Interpretation of Remission in Type 2 Diabetes. *Diabetes Care*. 2021. [PubMed](https://pubmed.ncbi.nlm.nih.gov/34462270/)
