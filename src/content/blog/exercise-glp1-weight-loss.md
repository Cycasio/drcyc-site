...
description: "用 Mounjaro、Ozempic 減重就可以不運動？研究顯示體重下降時可能同時減少瘦體組織，骨骼健康也需留意。用研究資料說明：為什麼運動是減重藥物的重要搭檔。"
pubDate: 2026-04-10
...
> **使用 GLP-1 類藥物減重時，應搭配阻力訓練（resistance training）來保留瘦體組織。**

阻力訓練的效果：
- ✅ **保留甚至增加肌肉量** — 讓身體知道「這些肌肉還有用，不要分解」
- ✅ **維持基礎代謝率** — 降低停藥後復胖的速度
- ✅ **改善胰島素敏感度** — 跟藥物效果加乘
...
- **進食狀態**（胰島素高）：GIP 受體活化 → 增強胰島素訊號 → 促進脂肪組織吸收血中三酸甘油酯 → **清血脂**
...
**藥物提供一段關鍵期。是否把運動納入生活，會影響接下來的健康與體重管理。**
