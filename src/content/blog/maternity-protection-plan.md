---
title: "母性保護計畫完整指南：懷孕、產後與哺乳期，企業該怎麼做"
description: "從法規到實務，母性保護計畫不是只填一張表。懷孕員工的夜班、化學暴露與搬運風險，該由誰評估、如何調整？由家庭醫學科專科醫師、職業醫學科訓練醫師整理。"
pubDate: 2026-05-01
...
faq:
  ...
  - q: "母性保護計畫書要包含哪些內容？"
    a: "計畫書應包含：(1) 政策聲明與主管承諾；(2) 適用對象與通知機制；(3) 危害辨識清單（化學品、輻射、人因、輪班等）；(4) 風險評估流程與評估工具；(5) 工作調整措施（包含暫時調職、班表調整、工作限制等）；(6) 哺乳期特別保護措施（授乳時間、哺乳室）；(7) 醫師評估機制（何時請職醫、書面建議書格式）；(8) 員工通知與保密機制；(9) 年度審查機制。"
  - q: "哺乳期有哪些特別規定？"
...
母性保護計畫，就是把這件事從「出問題才處理」變成「有制度就不會亂」。
...
實務上這條規定執行率很低。很多員工不知道自己有這個權利，很多雇主也沒有主動告知。母性保護計畫裡應該明確載明這條，讓員工知道可以主張，也讓主管知道不能刁難。

**哺乳室**

依《性別平等工作法》第 23 條，僱用受僱者 100 人以上之雇主，應提供哺集乳室及托兒設施或適當托兒措施。未達該門檻的企業也可以自願提供友善空間，但不要把自願措施與法定門檻混在一起。

我去過的公司裡，哺乳室品質落差很大。好一點的有冰箱、舒適座椅、鎖門、遮光；差一點的就是一間閒置的儲藏室加個簾子，連基本的電源插座都沒有。
...
實務上，企業要先建立安全、保密且可近用的通知管道；員工若希望啟動與個人健康狀態相關的保護，也需要讓指定聯絡人取得必要資訊。雇主一旦依法知悉，就應依危害與個案狀況啟動後續評估，不能把所有責任推回員工。
...
療程資訊高度敏感。員工若願意提出需求，應只向必要的指定聯絡人揭露最少資訊；主管通常只需知道工作限制或請假安排，不需要知道完整診療細節。

建議計畫書裡設計一個「私密通知管道」，讓員工可以只告知 HR 或職業護理人員，不需要讓直屬主管知道詳情。你只需要知道員工需要某些工作調整，不需要知道她在做什麼療程。
...
從事勞工健康服務之醫師在母性保護計畫裡做什麼？不是簽名蓋章那麼簡單。
...
說白一點，母性保護計畫做得好不好，取決於跨專業團隊是否真的完成危害辨識、健康評估、工作調整與追蹤，而不是文件上有沒有某個職稱的簽名。

---

## 計畫書要有什麼

計畫書是具體的執行文件，不是政策宣示。勞檢員會翻，而且會問你「這個有落實嗎」。
...
**教育訓練計畫**：HR、主管、員工要各接受哪些訓練，頻率是多少。

**年度審查**：計畫書不是一次做完就放著，每年要更新。
...
**計畫書是通用範本**。從網路下載一份通用格式填一填，裡面的危害項目完全不符合公司實際狀況。勞檢員問「你們化學品清單在哪裡」，HR 翻半天找不到，因為計畫書裡根本沒有連結。

**只有文件沒有執行**。計畫書說「懷孕員工應每三個月評估一次」，但員工懷孕七個月，中間只評估過一次。紀錄空白，代表沒執行。

**哺乳室設備不足**。設備太差實際上沒人用，等於沒設。

**把自願支持誤寫成法定身分**。例如把 IVF／IUI 直接列為現行辦法的法定對象，會讓員工與企業都誤解權利義務。

**主管不知道規定**。HR 做了計畫，但直屬主管不知道，繼續要求懷孕員工排夜班或搬重物，整個保護形同虛設。
...
如果你的公司還沒有母性保護計畫，或者計畫書是幾年前做的通用範本，現在是個好時機重新檢視一次。

我在高雄、屏東的企業做臨場服務，母性保護計畫的制定與評估都包含在服務範圍內。有需要的話，歡迎聯絡討論。
