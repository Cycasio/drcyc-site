...
## 異常工作負荷促發疾病預防計劃：過勞預防不是只要有份計劃書

有天，一個工廠的安衛主任拿著一疊文件來找我。

「陳醫師，我在網路上抓了一份範本，填好了。你幫我看一下，這樣應該過了吧？」

我翻了幾頁。公司名稱是填進去的，其他部分幾乎跟範本一字不差。輪班管理的那頁，寫的是「依各廠區情形彈性調整」——廠區情形是什麼？沒有說。加班時數的統計方式，寫的是「每月由各部門統計回報」——誰統計？怎麼統？沒有說。醫師面談流程有一格，填的是「定期辦理」——多久定期？對誰辦理？還是沒有說。
...
輪班管理有幾個公認的原則：順時針方向輪班（白班→小夜→大夜，而不是反方向）對生理時鐘衝擊較小；輪班間距至少要有 11 小時的休息；不要排連續超過 5 天的夜班。
...
實際的流程應該是這樣：健管師或護理師先整理健檢異常名單——血壓 ≥ 140/90、空腹血糖 ≥ 100、低密度膽固醇 ≥ 130 之類的門檻要事先定好。這份名單跟 HR 的加班統計交叉比對，找出「健康異常 × 高工作負荷」的員工。

醫師面談的時候，不是只是「告訴他血壓高要少吃鹽」。重點在評估他的工作負荷是不是健康異常的原因或加重因素——如果是，要出具書面的工作調整建議，比如「建議暫時免除夜班」或「建議降低加班時數上限」。

這份建議要正式送到 HR，HR 要有回覆。醫師有建議、公司沒有採取任何措施——這在法律上的意義，跟公司完全不知情是不一樣的。

我自己在做臨場服務的時候，每次面談結束我都會給一份書面建議。不是為了讓公司有文件可以應付稽查，而是因為這才是面談真正的意義——讓公司知道這個員工目前的狀況，以及合理的工作調整方向。
